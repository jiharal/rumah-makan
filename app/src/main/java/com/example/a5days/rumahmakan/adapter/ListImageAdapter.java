...
public class ListImageAdapter extends ArrayAdapter<ClassItem> {
    Context context;
    ...
    public ListImageAdapter(Context context, int layoutResourceId,
                            ClassItem[] data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with(context).load(item.icon).resize(0, 400).into(holder.imgIcon);
